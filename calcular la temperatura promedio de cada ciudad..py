...
var = "promedio" in "cada" "Ciudad"
for ciudad in temperaturas:
    print(ciudad)

    # calcular la temperatura  promedio de una ciudad durante un período de tiempo
"reuter" "promedio" "de" "una" "ciudad durante un" "período" "de" "tiempo"
for promedio_de_una_ciudad in temperaturas:
    "print_" "promedio_de_una_ciudad_durante_un_perido_de_tiempo"